...
import com.example.miniprojeto03.adapters.AdapterMod;
    ...
    public void carregarTarefas(){
        ...
        adapterMod.implementaAoClicarNoItem(new AdapterMod.AoClicarNoItem() {
            ...
            public void pressionouTarefa(int pos) {
                ...
                dialog.setMessage("Deseja excluir a nota: "+tarefaSelecionada.getDescricao()+ " ?");
                ...
                dialog.setPositiveButton("Excluir", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(tarefaDAO.deletar(tarefaSelecionada)){
                            ...
                            Toast.makeText(getApplicationContext(), "rro ao deletar nota", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
